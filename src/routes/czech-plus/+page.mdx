...
Since the start of [the russian invasion of Ukraine](https://en.wikipedia.org/wiki/Russian_invasion_of_Ukraine), I've moved to the Czech Republic. And so when you move to another country, you probably will have to learn their language soon or later. This is what I have been doing for last year and a half.
